(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/http'), require('rxjs/ReplaySubject')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/http', 'rxjs/ReplaySubject'], factory) :
	(factory((global['vidal-ngx-discovery'] = {}),global.ng.core,global.ng.common,global.ng.http,global.Rx));
}(this, (function (exports,core,common,http,ReplaySubject) { 'use strict';
...
var DISCOVERY_SERVICE_CONFIG = new core.InjectionToken('service.discovery.config');
var DiscoveryService = (function () {
    ...
    function DiscoveryService(http$$1, discoveryServiceConfig) {
        ...
        this.environment$ = new ReplaySubject.ReplaySubject(1);
...
DiscoveryService.ctorParameters = function () { return [
    { type: http.Http, },
    { type: undefined, decorators: [{ type: core.Inject, args: [DISCOVERY_SERVICE_CONFIG,] },] },
]; };
...
DiscoveryDirective.propDecorators = {
    'ngxDiscovery': [{ type: core.Input, args: ['ngxDiscovery',] },],
    'ngxDiscoveryParams': [{ type: core.Input, args: ['ngxDiscoveryParams',] },],
    'ngxDiscoveryTarget': [{ type: core.Input },],
};
...
exports.ɵa = DiscoveryDirective;
exports.ɵb = DISCOVERY_SERVICE_CONFIG;
exports.ɵc = DiscoveryService;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=vidal-ngx-discovery.umd.js.map
