...
const DISCOVERY_SERVICE_CONFIG = new InjectionToken('service.discovery.config');
class DiscoveryService {
    /**
     * @param {?} http
     * @param {?} discoveryServiceConfig
     */
    constructor(http$$1, discoveryServiceConfig) {
        this.http = http$$1;
...
//# sourceMappingURL=vidal-ngx-discovery.js.map
